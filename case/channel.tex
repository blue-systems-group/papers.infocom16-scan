...
Figure~\ref{fig:conflict} shows the constructed conflict graphs, where APs are positioned 
...
not all the conflict edges exist all the time: while $G_I$ is stable, $G_C$
...
However, \textit{CLIENT-OPT} can still achieve much fewer conflicts than
\textit{AP-OPT}.
